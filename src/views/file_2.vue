  ...
  <div>
    <div class="container">
      <div class="handle-box">
        <el-form :inline="true" size="mini" label-wid>
          <el-form-item label="核发机关:" prop="hefa">
            <el-select v-model="query.hefa" placeholder="请选择核发机关" class="handle-select mr10">
          ...
          <el-form-item label="车辆类别:" prop="kind">
            <el-select v-model="query.kind" placeholder="请选择车辆类别" class="handle-select mr10">
              <el-option key="1" label="广东省" value="广东省"></el-option>
              <el-option key="2" label="湖南省" value="湖南省"></el-option>
            </el-select>
          </el-form-item>
          ...
          <el-form-item label="经营状态:" prop="jingying">
            <el-select v-model="query.jingying" placeholder="营运" class="handle-select mr10">
              <el-option key="1" label="广东省" value="广东省"></el-option>
              <el-option key="2" label="湖南省" value="湖南省"></el-option>
            </el-select>
            <div class="btn">
      ...
      <el-table :data="tableData" border stripe height="540" class="table" ref="multipleTable" header-cell-class-name="table-header" :default-sort="{ prop: 'id' }">
        ...
        <el-table-column prop="rank" label="经营范围" align="center"></el-table-column>
