    ...
    <div class="container">
      <div class="handle-box">
        <el-form inline="true" size="small" label-wid>
          <el-form-item label="总评价:" prop="zhuangtai">
            <el-select
          ...
          <el-form-item label="运输企业:" prop="number">
            <el-input
      ...
      >
        ...
        <el-table-column
          ...
          align="center"
        ></el-table-column>
        <el-table-column prop="color" label="运输企业" align="center">
        </el-table-column>

        <el-table-column prop="kind2" label="乘车体验" align="center">
        </el-table-column>

        <el-table-column prop="Date" label="车辆卫生" align="center">
        </el-table-column>

        <el-table-column prop="rank" label="服务态度" align="center">
        </el-table-column>
        <el-table-column prop="name" label="总评价" align="center">
        </el-table-column>
        <el-table-column prop="name" label="电话号码" align="center">
        </el-table-column>
        <el-table-column prop="name" label="留言评价" align="center">
        </el-table-column>
