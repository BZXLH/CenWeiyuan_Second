    ...
    <div class="container">
      ...
      >
        ...
        <el-table-column
          ...
          align="center"
        ></el-table-column>
        <el-table-column prop="color" label="检查对象" align="center">
        </el-table-column>
        <el-table-column prop="kind1" label="检查内容" align="center">
        </el-table-column>
        <el-table-column prop="kind2" label="检查方式" align="center">
        </el-table-column>
