    ...
    <div class="container">
      ...
      >
        ...
        <el-table-column
          ...
          align="center"
        ></el-table-column>
        <el-table-column prop="color" label="公司名称" align="center">
        </el-table-column>

        <el-table-column prop="kind2" label="留言电话" align="center">
        </el-table-column>

        <el-table-column prop="Date" label="搭乘时间" align="center">
        </el-table-column>

        <el-table-column prop="rank" label="搭乘班次" align="center">
        </el-table-column>
        <el-table-column prop="name" label="提交时间" align="center">
        </el-table-column>
        <el-table-column prop="name" label="是否受理" align="center">
        </el-table-column>
