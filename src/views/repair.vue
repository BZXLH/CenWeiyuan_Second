    ...
    <div class="container">
      <div class="handle-box">
        <el-form inline="true" size="small" label-wid>
          ...
          <el-form-item label="终止时间:" prop="number">
            <el-input
              v-model="query.number"
              class="handle-input mr10"
            ></el-input>
      ...
      >
        ...
        <el-table-column prop="kind2" label="里程数" align="center">
        </el-table-column>

        <el-table-column prop="Date" label="修理厂名称" align="center">
        </el-table-column>

        <el-table-column prop="rank" label="进厂时间" align="center">
        </el-table-column>
        <el-table-column prop="name" label="上传用户" align="center">
        </el-table-column>
        <el-table-column prop="name" label="上传时间" align="center">
        </el-table-column>
        <el-table-column prop="name" label="是否审核" align="center">
        </el-table-column>
